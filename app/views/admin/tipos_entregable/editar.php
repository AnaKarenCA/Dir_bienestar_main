...
<head>
    ...
    <title>Editar Tipo de Entregable</title>
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200" />
    <style>
        /* (Mismos estilos que la vista agregar) */
...
<div class="contenido">
    <h2><span class="material-symbols-outlined">edit</span> Editar Tipo de Entregable</h2>
    <div class="form-card">
        <form id="formEditar">
            <div class="form-group">
                <label>Nombre del tipo de entregable *</label>
                <input type="text" name="nombre_entregable" value="<?= htmlspecialchars($tipo['nombre_entregable']) ?>" required>
            </div>
...
document.getElementById('formEditar').addEventListener('submit', async function(e) {
    ...
    try {
        const res = await fetch('/Dir_bienestar/admin/actualizar_tipo_entregable/<?= $tipo['id'] ?>', {
            method: 'POST',
        ...
        if (result.success) {
            ...
            mensaje.textContent = '✅ Tipo actualizado correctamente. Redirigiendo...';
